...
async function addCanvaAutomationSchema() {
  ...
  try {
    ...
    console.log('✅ Canva Automation Schema created successfully!');
    ...
    console.error('❌ Error creating Canva Automation Schema:', error);
    throw error;
  }
}
...
addCanvaAutomationSchema()
  .then(() => {
    console.log('🎉 Canva Automation Schema migration completed!');
    process.exit(0);
  })
  .catch((error) => {
