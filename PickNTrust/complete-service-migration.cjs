...
console.log('🔄 Running complete service migration...');
...
try {
  ...
  console.log('🔄 Setting default values for existing products...');
  ...
  sqlite.close();
  console.log('🎉 Complete service migration finished successfully!');
