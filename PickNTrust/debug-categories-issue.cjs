...
console.log('🔍 Debugging Categories API Issue...');
...
async function debugCategoriesIssue() {
  try {
    ...
    if (displayOrderColumn) {
      ...
      console.log('⚠️  display_order column missing - running migration...');
      ...
      try {
        ...
        console.log('✅ Set initial display orders');
      } catch (error) {
    ...
    try {
      ...
      console.log('❌ API query simulation failed:', error.message);
    }
    ...
    sqlite.close();
    console.log('\n✅ Categories debugging completed');
