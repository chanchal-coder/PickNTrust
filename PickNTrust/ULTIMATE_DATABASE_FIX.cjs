...
console.log('\n🎯 WHAT THIS FIXES:');
console.log('==================');
console.log('✅ Creates canva_settings table in the correct database (sqlite.db)');
console.log('✅ Adds default_caption and default_hashtags fields for manual templates');
console.log('✅ Creates canva_posts and canva_templates tables');
console.log('✅ Inserts default settings with manual caption/hashtag templates');
console.log('✅ Restarts PM2 to apply changes');
console.log('✅ Resolves "SqliteError: no such table: canva_settings" error');
