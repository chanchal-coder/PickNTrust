...
try {
  ...
  console.log(`canva_settings table exists: ${canvaSettingsExists ? '✅ YES' : '❌ NO'}`);
  ...
  `);
  console.log('✅ canva_posts table ensured');
  ...
  `);
  console.log('✅ canva_templates table ensured');

  // 5. Insert default settings
  console.log('\n📝 Step 5: Inserting default settings...');
  ...
  console.log('✅ Default settings inserted with manual templates');
  ...
  console.log(`\n✅ default_caption field: ${hasDefaultCaption ? 'PRESENT' : 'MISSING'}`);
  console.log(`✅ default_hashtags field: ${hasDefaultHashtags ? 'PRESENT' : 'MISSING'}`);
  ...
  if (fs.existsSync(distPath)) {
    console.log('📦 dist folder exists - TypeScript rebuild recommended');
    console.log('🔄 You should run: npm run build');
  } else {
    console.log('📦 No dist folder found - development mode');
  }

  console.log('\n🎉 DATABASE SCHEMA FIX COMPLETE!');
  console.log('\n📋 What was fixed:');
  console.log('  ✅ Recreated canva_settings table with correct Drizzle ORM schema');
  console.log('  ✅ Added default_caption and default_hashtags fields');
  console.log('  ✅ Ensured all Canva-related tables exist');
  console.log('  ✅ Inserted default settings with manual templates');
  console.log('  ✅ Schema now matches shared/sqlite-schema.ts exactly');
  ...
  console.log('\n✨ Manual Caption/Hashtag Fields Ready:');
