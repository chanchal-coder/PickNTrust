                ...
                <div className="p-4 bg-gray-800 text-white space-y-2 relative">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {(product as any).isFree || ((product as any).pricingType === 'free') ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-blue-400">₹{(product as any).monthlyPrice}/month</span>
                        {product.originalPrice && (
                          <span className="text-gray-500 line-through text-sm">₹{product.originalPrice}/month</span>
                        )}
                      </div>
                    ) : (product as any).yearlyPrice && (product as any).yearlyPrice !== '0' ? (
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-blue-400">₹{(product as any).yearlyPrice}/year</span>
                        {product.originalPrice && (
                          <span className="text-gray-500 line-through text-sm">₹{product.originalPrice}/year</span>
                        )}
                      </div>
                    ) : (
                      <div className="flex items-center space-x-2">
                        ...
                        {(product as any).pricingType === 'monthly' ? (
                          <span className="text-lg font-bold text-blue-400">₹{product.price}/month</span>
                        ) : (product as any).pricingType === 'yearly' ? (
                          <span className="text-lg font-bold text-blue-400">₹{product.price}/year</span>
                        ) : (
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    {(product as any).isFree || ((product as any).pricingType === 'free') ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-purple-600 dark:text-purple-400">₹{(product as any).monthlyPrice}/month</span>
                        {product.originalPrice && (
                          <span className="text-gray-500 line-through text-sm">₹{product.originalPrice}/month</span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-purple-600 dark:text-purple-400">₹{(product as any).yearlyPrice}/year</span>
                        {product.originalPrice && (
                          <span className="text-gray-500 line-through text-sm">₹{product.originalPrice}/year</span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        {/* For regular price, check pricingType to determine suffix */}
                        {(product as any).pricingType === 'monthly' ? (
                          <span className="text-lg font-bold text-purple-600 dark:text-purple-400">₹{product.price}/month</span>
                        ) : (product as any).pricingType === 'yearly' ? (
                          <span className="text-lg font-bold text-purple-600 dark:text-purple-400">₹{product.price}/year</span>
                        ) : (
