                      ...
                      {(product as any).isFree || ((product as any).pricingType === 'free') ? (
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {product.originalPrice && (
                            <span className="text-gray-400 dark:text-gray-500 line-through ml-2 text-base">₹{product.originalPrice}/month</span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {product.originalPrice && (
                            <span className="text-gray-400 dark:text-gray-500 line-through ml-2 text-base">₹{product.originalPrice}/year</span>
                          )}
                        </div>
                      ) : (
                        <div className="flex items-center space-x-2">
