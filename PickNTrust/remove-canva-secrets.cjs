...
console.log('🧹 Removing all Canva API secrets from codebase...\n');
...
console.log('\n🎉 All Canva API secrets have been removed from the codebase!');
console.log('✅ GitHub Push Protection should now be satisfied.');
