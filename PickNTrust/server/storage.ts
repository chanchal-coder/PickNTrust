...
export class DatabaseStorage implements IStorage {
  ...
  async addProduct(product: any): Promise<Product> {
    try {
      ...
      if (product.isService) {
        // For services, handle pricing based on type and available fields
        ...
        if (isFree || pricingType === 'free') {
          price = 0;
          pricingType = 'free';
          console.log('Setting as free service');
          ...
          pricingType = 'monthly';
          console.log('Setting as monthly service:', price);
          ...
          pricingType = 'yearly';
          console.log('Setting as yearly service:', price);
          ...
          console.log('Setting as one-time service:', price);
        } else {
        ...
        // Handle original price for services
