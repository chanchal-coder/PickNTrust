...
try {
  ...
  if (timerColumn.type === 'TEXT') {
    ...
    console.log('✅ Successfully converted timer_start_time to INTEGER');
  } else {
    console.log('✅ timer_start_time column type is already correct');
  }
  ...
  if (blogTimerColumn && blogTimerColumn.type === 'TEXT') {
    ...
    console.log('✅ Fixed blog_posts timer_start_time column');
  }
