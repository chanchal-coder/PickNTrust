...
// Connect to the ROOT database (./database.sqlite)
const dbPath = path.join(__dirname, 'database.sqlite');
const db = new Database(dbPath);

console.log('🗄️ Creating advertising system tables in ROOT database...');
...
try {
  ...
  console.log('\n✅ All advertising tables created successfully in ROOT database!');
