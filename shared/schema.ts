...
export const products = pgTable("products", {
  ...
  // Affiliate automation fields
  originalUrl: text("original_url"), // Original product URL before affiliate transformation
  affiliateProgram: text("affiliate_program"), // amazon_associates, earnkaro, etc.
  commissionRate: text("commission_rate"), // Commission rate as string (e.g., "4.5%")
  merchantDomain: text("merchant_domain"), // Domain of the merchant (e.g., "amazon.com")
  targetPage: text("target_page"), // Where to display: todays_top_picks, apps_ai, lootbox, etc.
  tags: text("tags"), // Comma-separated tags: viral, trending, featured
  categoryId: integer("category_id"), // Reference to categories table
  isActive: boolean("is_active").default(true), // Whether product is active
