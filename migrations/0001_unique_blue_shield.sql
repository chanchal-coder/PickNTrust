...
CREATE TABLE `__new_admin_users` (
	...
	`last_login` integer,
	`created_at` integer DEFAULT '"2025-09-05T13:10:48.642Z"',
...
CREATE TABLE `__new_apps_products` (
	...
	`created_at` integer DEFAULT '"2025-09-05T13:10:48.646Z"',
	`updated_at` integer DEFAULT '"2025-09-05T13:10:48.646Z"',
	`expires_at` integer,
...
CREATE TABLE `__new_canva_posts` (
	...
	`posted_at` integer,
	`expires_at` integer,
	`created_at` integer DEFAULT '"2025-09-05T13:10:48.645Z"',
	`updated_at` integer DEFAULT '"2025-09-05T13:10:48.645Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_exchange_rates` (
	...
	`last_updated` integer DEFAULT '"2025-09-05T13:10:48.645Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_newsletter_subscribers` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`email` text NOT NULL,
	`subscribed_at` integer DEFAULT '"2025-09-05T13:10:48.642Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_products` (
	...
	`affiliate_link` text,
	`created_at` integer DEFAULT '"2025-09-05T13:10:48.642Z"',
	`updated_at` integer DEFAULT '"2025-09-05T13:10:48.642Z"',
