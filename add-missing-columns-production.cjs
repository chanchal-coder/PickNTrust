...
try {
  ...
  if (!videoTableExists) {
    try {
      ...
      console.log('   ✅ Added video_content indexes');
  ...
  // Verify the changes
  console.log('\n✅ Verification - Updated products table structure:');
  ...
  try {
    ...
    console.log(`   ✅ Successfully inserted test service product (ID: ${result.lastInsertRowid})`);
