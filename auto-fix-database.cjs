...
function fixDatabase() {
  ...
  try {
    ...
    try {
      ...
      console.log('Success Added originalPrice to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add originalPrice:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added imageUrl to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add imageUrl:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added affiliateUrl to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add affiliateUrl:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added affiliateNetworkId to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add affiliateNetworkId:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added reviewCount to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add reviewCount:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added isNew to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add isNew:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added isFeatured to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add isFeatured:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added isService to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add isService:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added customFields to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add customFields:', e.message);
      }
    ...
    // Add pricingType to sqlite.db: products
    try {
      db.prepare('ALTER TABLE sqlite.db: products ADD COLUMN pricingType TEXT').run();
      console.log('Success Added pricingType to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
    ...
    // Add monthlyPrice to sqlite.db: products
    try {
      db.prepare('ALTER TABLE sqlite.db: products ADD COLUMN monthlyPrice TEXT').run();
      console.log('Success Added monthlyPrice to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
    ...
    // Add yearlyPrice to sqlite.db: products
    try {
      db.prepare('ALTER TABLE sqlite.db: products ADD COLUMN yearlyPrice TEXT').run();
      console.log('Success Added yearlyPrice to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
    ...
    // Add isFree to sqlite.db: products
    try {
      db.prepare('ALTER TABLE sqlite.db: products ADD COLUMN isFree INTEGER DEFAULT 0').run();
      console.log('Success Added isFree to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
    ...
    // Add priceDescription to sqlite.db: products
    try {
      db.prepare('ALTER TABLE sqlite.db: products ADD COLUMN priceDescription NUMERIC').run();
      console.log('Success Added priceDescription to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
    ...
    try {
      ...
      console.log('Success Added hasTimer to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add hasTimer:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added timerDuration to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add timerDuration:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added timerStartTime to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add timerStartTime:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added createdAt to sqlite.db: products');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add createdAt:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added isActive to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add isActive:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added textColor to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add textColor:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added backgroundColor to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add backgroundColor:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added fontSize to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add fontSize:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added fontWeight to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add fontWeight:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added textDecoration to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add textDecoration:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added fontStyle to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add fontStyle:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added animationSpeed to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add animationSpeed:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added textBorderWidth to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add textBorderWidth:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added textBorderStyle to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add textBorderStyle:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added textBorderColor to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add textBorderColor:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added bannerBorderWidth to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add bannerBorderWidth:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added bannerBorderStyle to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add bannerBorderStyle:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added bannerBorderColor to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add bannerBorderColor:', e.message);
      }
    ...
    try {
      ...
      console.log('Success Added createdAt to sqlite.db: announcements');
    } catch (e) {
      if (!e.message.includes('duplicate column')) {
        console.log('Error Failed to add createdAt:', e.message);
      }
