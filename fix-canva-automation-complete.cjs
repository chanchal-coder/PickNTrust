...
try {
  ...
  if (enableResult.changes > 0) {
    ...
    console.log('⚠️ No settings found to enable');
  }
  ...
  `);
  console.log('✅ canva_posts table ready');
  ...
  `);
  console.log('✅ canva_templates table ready');
  ...
  if (updateSettings.changes > 0) {
    console.log('✅ Canva settings updated');
  }
  ...
  console.log('\n🎉 CANVA AUTOMATION FIX COMPLETE!');
  console.log('=====================================');
  console.log('✅ Canva automation enabled');
  console.log('✅ All required tables created');
  console.log('✅ Default template configured');
  console.log('✅ Multi-platform posting enabled');
  console.log('✅ Professional templates ready');
