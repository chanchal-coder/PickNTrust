import { dbInstance as db } from './server/db.mts';
...
async function seedCategories() {
  try {
    ...
    console.log(`✅ Successfully seeded ${initialCategories.length} categories!`);
    
    // Verify the seed
    const seededCategories = await db.select().from(categories);
    console.log(`🔍 Verification: ${seededCategories.length} categories in database`);
