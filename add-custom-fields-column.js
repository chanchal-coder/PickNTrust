...
console.log('Refresh Adding customFields column to products table...');
...
try {
  ...
  if (hasCustomFields) {
    console.log('Success customFields column already exists in products table');
  } else {
    ...
    `);
    console.log('Success Successfully added customFields column to products table');
  }
  ...
  console.error('Error Error during database migration:', error.message);
  process.exit(1);
}
