...
console.log('🔍 Diagnosing Canva automation issues...\n');
...
try {
  ...
  try {
    ...
    console.log(`✅ Canva posts table exists with ${canvaPosts.count} records`);
    ...
    console.log('❌ Canva posts table not found or error:', error.message);
  }
  ...
  try {
    ...
    console.log(`✅ Canva templates table exists with ${templates.count} records`);
  } catch (error) {
    console.log('❌ Canva templates table not found or error:', error.message);
  }
  ...
  try {
    ...
    console.log('✅ Canva service import would work (file exists)');
  } catch (error) {
    console.log('❌ Canva service import error:', error.message);
  }
  ...
  if (!canvaSettings) {
    console.log('❌ CRITICAL: No Canva settings found in database');
