...
console.log('🔄 Adding enhanced service pricing fields...');
...
try {
  ...
  console.log('📝 Adding pricingType column...');
  sqlite.exec(`
    ALTER TABLE products 
    ADD COLUMN pricingType TEXT;
  `);

  console.log('📝 Adding monthlyPrice column...');
  sqlite.exec(`
    ALTER TABLE products 
    ADD COLUMN monthlyPrice TEXT;
  `);

  console.log('📝 Adding yearlyPrice column...');
  sqlite.exec(`
    ALTER TABLE products 
    ADD COLUMN yearlyPrice TEXT;
  `);

  console.log('📝 Adding isFree column...');
  sqlite.exec(`
    ALTER TABLE products 
    ADD COLUMN isFree INTEGER DEFAULT 0;
  `);

  console.log('📝 Adding priceDescription column...');
  sqlite.exec(`
    ALTER TABLE products 
  ...
  console.log('🔄 Updating existing services with default pricing...');
  sqlite.exec(`
    UPDATE products 
  ...
  console.log('✅ Service pricing fields migration completed successfully!');
  console.log('📊 Services now support flexible pricing options');
