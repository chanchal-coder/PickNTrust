# Deploy unified_content table creation to EC2
$EC2_USER = "ubuntu"
...
Write-Host "Creating unified_content table on EC2..." -ForegroundColor Yellow
ssh -i $SSH_KEY -o StrictHostKeyChecking=no $EC2_USER@$EC2_IP 'cd /var/www/pickntrust && npm install better-sqlite3 && node ~/create-unified-table.cjs'
