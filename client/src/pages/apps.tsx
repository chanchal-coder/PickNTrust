                      ...
                      {/* Enhanced pricing display for apps page */}
                       {(app as any).isFree || ((app as any).pricingType === 'free') ? (
                         ...
                         <div className="flex items-center space-x-2">
                           ...
                           {app.originalPrice && (app as any).pricingType !== 'One-time Payment' && (
                             <span className="text-gray-500 line-through text-sm">
                               {formatProductPrice(app.originalPrice, app.currency)}
                               {(app as any).pricingType === 'Monthly Subscription' ? '/month' : (app as any).pricingType === 'Yearly Subscription' ? '/year' : ''}
                             </span>
                           )}
                         </div>
                       )}
