...
export default function TopPicks() {
  ...
  const handleShare = (platform: string, product: Product) => {
    ...
    const shareText = `Check out this amazing deal: ${product.name} - Only ${formatPrice(product.price, product.currency || 'INR')}! ${product.discount ? `${product.discount}% OFF!` : ''} - PickNTrust`;
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-extrabold text-white mb-6 leading-relaxed">
              Today's Top Picks 🔥
            </h1>
            <p className="text-lg md:text-xl text-white/90 mb-6">
              Hand-selected deals you can trust - Updated daily
                      ...
                      {(product as any).isFree || ((product as any).pricingType === 'free') ? (
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {product.originalPrice && (
                            <span className="text-gray-400 dark:text-gray-500 line-through ml-2 text-base">{formatPrice(product.originalPrice, (product as any).currency || 'INR')}/month</span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {product.originalPrice && (
                            <span className="text-gray-400 dark:text-gray-500 line-through ml-2 text-base">{formatPrice(product.originalPrice, (product as any).currency || 'INR')}/year</span>
                          )}
                        </div>
                      ) : (
                        <div className="flex items-center space-x-2">
