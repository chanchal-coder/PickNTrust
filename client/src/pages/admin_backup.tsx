...
function ProductManagementCard({ product, onUpdate, onDelete }: { product: any, onUpdate: () => void, onDelete: () => void }) {
  ...
  return (
    <UniversalPageLayout pageId="admin_backup">
...
export default function AdminPage() {
  ...
  // Authentication complete - password management removed
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex flex-wrap gap-2">
                {achievements.map((achievement, index) => (
                  <div key={index} className="flex items-center gap-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 px-3 py-1 rounded-full text-sm font-medium transition-transform hover:scale-105 animate-pulse">
                    <span className="text-yellow-600"><i className="fas fa-trophy"></i></span>
                    {achievement}
                  </div>
                ))}
              </div>
          ...
          <div className="mb-8">
            <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg max-w-md">
              ...
              >
                <i className="fas fa-edit"></i> Blog Posts
              </button>
            </div>
          </div>
          ...
          {activeTab === 'products' && (
            ...
            <CardHeader>
              <CardTitle className="text-xl text-bright-blue"><i className="fas fa-rocket"></i> Auto-Extract Product Details</CardTitle>
              <CardDescription>
            ...
            <Card className="mb-8 border-green-200 dark:border-green-800">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <CardTitle className="text-green-700 dark:text-green-400">
                      {isEditingPreview ? '<i className="fas fa-pencil-alt"></i> Edit Product Details' : '<i className="fas fa-clipboard"></i> Product Preview'}
                    </CardTitle>
                    <CardDescription>
                      {isEditingPreview 
              ...
              <CardContent className="pt-6">
                ...
                <div className="flex gap-3 mt-6 pt-4 border-t">
                  ...
                  >
                    <i className="fas fa-check"></i> Add Product to Catalog
                  </Button>
                  <Button
                    variant="outline"
                    onClick={() => {
          ...
          {activeTab === 'blog' && (
            <>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    >
                      <div className="space-y-2">
                        <div className="text-3xl"><i className="fas fa-folder"></i></div>
                        ...
                        <div className="flex justify-center gap-2 text-xs text-gray-400">
                          <span><i className="fas fa-camera"></i> JPG, PNG, GIF</span>
                          <span>•</span>
                          <span><i className="fas fa-film"></i> MP4, WEBM, MOV</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-blue-600 mt-1 space-y-1">
                          <div><i className="fas fa-mobile-alt"></i> Instagram: https://www.instagram.com/reel/ABC123/</div>
                          <div>📘 Facebook: https://www.facebook.com/reel/123456789</div>
                          <div><i className="fas fa-film"></i> YouTube: https://youtube.com/watch?v=ABC123</div>
                        </div>
                        <div className="mt-2 p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-800">
                          <p className="text-xs text-green-700 dark:text-green-300 font-medium">
                            <i className="fas fa-folder"></i> Upload your own content or share social media links - perfect for personal blogging!
                          </p>
                        </div>
                        ...
                        {blogFormData.videoUrl && (
                          <div className="mt-2">
                            ...
                            <div className="mt-1 text-xs">
                              {blogFormData.videoUrl.includes('youtube.com') || blogFormData.videoUrl.includes('youtu.be') ? (
                                <span className="text-green-600 dark:text-green-400"><i className="fas fa-check"></i> YouTube video embedded</span>
                              ) : blogFormData.videoUrl.includes('instagram.com') ? (
                                <span className="text-purple-600 dark:text-purple-400"><i className="fas fa-check"></i> Instagram content linked</span>
                              ) : blogFormData.videoUrl.includes('facebook.com') ? (
                                <span className="text-blue-600 dark:text-blue-400"><i className="fas fa-check"></i> Facebook content linked</span>
                              ) : blogFormData.videoUrl.startsWith('/uploads/') ? (
                                <span className="text-green-600 dark:text-green-400"><i className="fas fa-check"></i> Personal video uploaded</span>
                              ) : (
              ...
              <Card className="mb-8 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-800">
                <CardHeader>
                  <CardTitle className="text-xl text-purple-600 dark:text-purple-400"><i className="fas fa-lightbulb"></i> Blog Content Ideas</CardTitle>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-4 gap-6">
                    ...
                    <div>
                      <h4 className="font-semibold text-navy dark:text-blue-400 mb-2"><i className="fas fa-mobile-alt"></i> Social Media Integration</h4>
                      <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                    ...
                    <div>
                      <h4 className="font-semibold text-navy dark:text-blue-400 mb-2"><i className="fas fa-folder"></i> Personal Content</h4>
                      <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                      ...
                      <div className="mt-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                        <p className="text-xs text-orange-700 dark:text-orange-300 font-medium">
                          <i className="fas fa-folder"></i> New: Upload images & videos up to 50MB each for personal touch!
                        </p>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className="flex items-center gap-4 text-xs text-gray-500">
                              ...
                              {post.videoUrl && (
                                <span className="flex items-center gap-1">
                                  <span>
                                    {post.videoUrl.includes('instagram.com') ? '<i className="fas fa-mobile-alt"></i>' : 
                                     post.videoUrl.includes('facebook.com') ? '📘' : 
                                     post.videoUrl.includes('youtube.com') ? '<i className="fas fa-film"></i>' : '<i className="fas fa-video"></i>'}
                                  </span> 
                ...
                <article className="max-w-none">
                  <div className="mb-4">
                    <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
                      <span><i className="fas fa-calendar-alt"></i> {blogFormData.publishedAt}</span>
                      <span>•</span>
                        ...
                        {blogFormData.videoUrl.includes("youtube.com") || blogFormData.videoUrl.includes("youtu.be") ? (
                          <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                            <div className="text-center text-gray-500 dark:text-gray-400">
                              <div className="text-4xl mb-2"><i className="fas fa-film"></i></div>
                          ...
                          <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                            <div className="text-center text-gray-500 dark:text-gray-400">
                              <div className="text-4xl mb-2"><i className="fas fa-video"></i></div>
