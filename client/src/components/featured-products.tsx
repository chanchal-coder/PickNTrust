                ...
                <div className="p-4 bg-gray-800 text-white space-y-2 relative">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {(product as any).isFree || ((product as any).pricingType === 'free') ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-blue-400">{formatProductPrice((product as any).monthlyPrice, product.currency)}/month</span>
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-lg font-bold text-blue-400">{formatProductPrice((product as any).yearlyPrice, product.currency)}/year</span>
                        {product.originalPrice && (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {(product as any).pricingType === 'monthly' ? (
                          <span className="text-lg font-bold text-blue-400">{formatProductPrice(product.price, product.currency)}/month</span>
                        ) : (product as any).pricingType === 'yearly' ? (
                          <span className="text-lg font-bold text-blue-400">{formatProductPrice(product.price, product.currency)}/year</span>
                        ) : (
                          <span className="text-lg font-bold text-blue-400">{formatProductPrice(product.price, product.currency)}</span>
                        )}
                        {product.originalPrice && (
