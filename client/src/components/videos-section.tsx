...
const sampleVideos: VideoContent[] = [
  {
    ...
    duration: "12:45",
    ctaText: "Shop Now",
    ctaUrl: "https://amazon.in/electronics",
  ...
  },
  {
    ...
    duration: "8:30",
    ctaText: "Apply Now",
    ctaUrl: "https://hdfcbank.com/credit-cards",
    createdAt: new Date().toISOString()
  },
  {
    id: 2003,
  ...
  const handleShare = (platform: string, video: VideoContent) => {
    ...
    switch (platform) {
      ...
      case 'whatsapp':
        ...
        break;
      case 'instagram':
        const instagramText = `<i className="fas fa-film"></i> Amazing Video Alert! ${video.title}\n\n<i className="fas fa-edit"></i> ${video.description}\n\n⏱️ Duration: ${video.duration}\n\n<i className="fas fa-sparkles"></i> Watch more at PickNTrust\n\n#PickNTrust #Videos #${video.category.replace(/\s+/g, '')}`;
