...
export default function StickyCtaButton() {
  ...
  const deals = [
    { text: "🔥 Hot Deal: iPhone 15 - 25% Off!", link: "/category/Mobiles%20%26%20Accessories" },
    { text: "⚡ Flash Sale: Laptops up to 40% Off!", link: "/category/Computers%20%26%20Laptops" },
    { text: "🎯 Limited Time: Fashion 50% Off!", link: "/category/Fashion%20Men" },
    { text: "🏠 Home Appliances - Big Savings!", link: "/category/Appliances" }
  ];
