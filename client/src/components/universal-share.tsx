...
export default function UniversalShare({ 
  ...
  const shareData = {
    ...
    text: `Check out this amazing ${product.category ? product.category.toLowerCase() : 'product'}: ${product.name} - Only ${formatPrice(product.price, product.currency || 'INR')} at PickNTrust!`,
