                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          {(product as any).isFree || (product.pricingType === 'free') ? (
                            ...
                            <p className="text-sm font-semibold text-green-600 dark:text-green-400">{formatPrice(product.monthlyPrice, product.currency || 'INR')}/month</p>
                      ) : product.yearlyPrice && product.yearlyPrice !== '0' ? (
                        <p className="text-sm font-semibold text-green-600 dark:text-green-400">{formatPrice(product.yearlyPrice, product.currency || 'INR')}/year</p>
                      ) : product.pricingType === 'monthly' ? (
                        <p className="text-sm font-semibold text-green-600 dark:text-green-400">{formatPrice(product.price, product.currency || 'INR')}/month</p>
                      ) : product.pricingType === 'yearly' ? (
                        <p className="text-sm font-semibold text-green-600 dark:text-green-400">{formatPrice(product.price, product.currency || 'INR')}/year</p>
                      ) : (
                        <p className="text-sm font-semibold text-green-600 dark:text-green-400">{formatPrice(product.price, product.currency || 'INR')}</p>
                          )}
                        </div>
                      </div>
                    ))}
