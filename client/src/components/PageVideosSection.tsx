...
export default function PageVideosSection({ page, title }: PageVideosSectionProps) {
  ...
  // Don't render if no videos for this page
        ...
        <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {videos.slice(0, 6).map((video: VideoContent) => {
            ...
            return (
              <div 
                key={video.id}
                className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 cursor-pointer group"
