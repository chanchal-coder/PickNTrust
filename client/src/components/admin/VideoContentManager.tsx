...
export default function VideoContentManager() {
  ...
  const addVideoMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      // Trigger Canva automation for the newly added video
      if (data && data.id) {
        try {
          console.log('🎨 Triggering Canva automation for new video:', data.id);
          ...
          if (canvaResponse.ok) {
            ...
            toast({
              title: '🎨 Video Added!',
              description: 'Video content added and Canva automation started for social media posting.',
            });
          } else {
            console.log('⚠️ Canva automation failed, but video was added successfully');
            toast({
              title: 'Video Added ✅',
              description: 'Video content added successfully! (Canva automation may be disabled)',
            });
          }
        } catch (canvaError) {
          ...
          toast({
            title: 'Video Added ✅',
            description: 'Video content added successfully! (Canva automation encountered an issue)',
          });
        }
      } else {
        toast({
