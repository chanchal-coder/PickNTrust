...
export default function VideoContentManager() {
  ...
  const availablePages = [
    { value: 'home', label: '<i className="fas fa-home"></i> Home Page', description: 'Main website homepage' },
    { value: 'services', label: '<i className="fas fa-tools"></i> Services Page', description: 'Services and subscriptions' },
    { value: 'apps', label: '<i className="fas fa-mobile-alt"></i> Apps Page', description: 'Apps and AI tools' },
    { value: 'blog', label: '<i className="fas fa-edit"></i> Blog Page', description: 'Blog articles and posts' },
    { value: 'top-picks', label: '<i className="fas fa-fire"></i> Top Picks', description: 'Today\'s top picks and featured deals' },
