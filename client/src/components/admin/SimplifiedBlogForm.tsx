        ...
        try {
          ...
          if (settingsResponse.ok) {
            ...
            if (isBlogAutomationEnabled && settings.isEnabled) {
              console.log('🎨 Triggering Canva automation for new blog post:', data.id);
              ...
              if (canvaResponse.ok) {
                ...
                console.log('⚠️ Canva automation failed, but blog post was added successfully');
                toast({
                  title: 'Blog Post Published ✅',
              ...
              console.log('ℹ️ Blog post automation is disabled in settings');
              toast({
                title: 'Blog Post Published ✅',
            ...
            console.log('⚠️ Could not fetch Canva settings, skipping automation');
            toast({
              title: 'Blog Post Published ✅',
            ...
            <form onSubmit={handleAddPost} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  placeholder="10 Best Budget Smartphones Under $500"
