...
try {
  ...
  if (!tableExists) {
    console.log('⚠️  canva_settings table does not exist. Creating it...');
    ...
    console.log('✅ Created canva_settings table with all columns including default_title');
  } else {
    ...
    if (hasDefaultTitle) {
      console.log('✅ default_title column already exists');
    } else {
      ...
      console.log('✅ Added default_title column successfully');
    }
  }
  ...
  console.log('✅ The canva_settings table now has all required columns:');
  console.log('   - default_title ✅');
  console.log('   - default_caption ✅');
  console.log('   - default_hashtags ✅');
